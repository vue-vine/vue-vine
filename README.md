...
- VSCode extension: &nbsp; [![VSCode ext version](https://vsmarketplacebadges.dev/version-short/shenqingchuan.vue-vine-extension.svg)](https://marketplace.visualstudio.com/items?itemName=shenqingchuan.vue-vine-extension)
