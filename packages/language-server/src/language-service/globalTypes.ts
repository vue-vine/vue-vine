import { getSlotsPropertyName, type VueCompilerOptions } from "@vue/language-core";

// copy from https://github.com/vuejs/language-tools/blob/28b1dd6e6bf374d17887e47d1625f080da832925/packages/language-core/lib/generators/script.ts#L190
export function generateGlobalHelperTypes(vueCompilerOptions: VueCompilerOptions) {
