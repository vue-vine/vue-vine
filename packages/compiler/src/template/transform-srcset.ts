import type { NodeTransform, RootNode, TemplateChildNode, TransformContext } from '@vue/compiler-core'
import type { AssetURLOptions } from './transform-asset-url'
...
import { defaultAssetUrlOptions } from './transform-asset-url'
...
type SrcsetTransformer = (
  node: RootNode | TemplateChildNode,
  context: TransformContext,
  options?: Required<AssetURLOptions>,
) => void

export const transformSrcset: SrcsetTransformer = (
  node: RootNode | TemplateChildNode,
  context: TransformContext,
...
export function createSrcsetTransformWithOptions(options: Required<AssetURLOptions>): NodeTransform {
  return (node, context) =>
